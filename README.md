...
This docker project provides an ELK stack installation, a nginx web server and a Flask app. 

This repository is the solution of the practice available at [elk-flask-nginx-practice](https://github.com/alefiori82/elk-flask-nginx-practice).
